...
llm = ChatOllama(model="llama3.2", base_url="https://ba5a-138-121-113-25.ngrok-free.app/", streaming=True)
...
async def answer_question_streaming(question: str):
    chunks = None
    print(chunks)
    if chunks is None:
        chunks = generate_chunks()
        print("Chunks generados con exito!")
